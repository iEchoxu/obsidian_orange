...
```ad-note
title:修改菜单操作步骤
- 去 [iconpark](https://iconpark.oceanengine.com/official) 找到自己喜欢的图标,然后“复制为svg代码”
- 通过 [svg->DataURI](https://codepen.io/jakob-e/pen/doMoML) 将svg代码转换为"DataURI"代码
- 通过开发者工具找到菜单对应的css类名
- 给菜单对应的css类名添加如下代码并将上面复制的DataURI代码作为`background-image`的值
```
